...
(() => {
var exports = {};
exports.id = "pages/api/vote/[id]";
exports.ids = ["pages/api/vote/[id]"];
exports.modules = {
...
/***/ "(api)/./pages/api/vote/[id].js":
/*!********************************!*\
  !*** ./pages/api/vote/[id].js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _lib_mongodb__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../lib/mongodb */ \"(api)/./lib/mongodb.ts\");\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{\n    try {\n        const mongoClient = await _lib_mongodb__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n        const result = await mongoClient.db(\"MetaLiberation\").collection(\"vote\").findOne({\n            projectId: req.query.id\n        });\n        return res.status(200).json({\n            success: true,\n            data: result\n        });\n    } catch (err) {\n        console.log(err.message);\n        return res.status(500).json({\n            success: false\n        });\n    }\n});\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/vote/[id].js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/vote/[id].js"));
