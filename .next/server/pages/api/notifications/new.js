...
(() => {
var exports = {};
exports.id = "pages/api/notifications/new";
exports.ids = ["pages/api/notifications/new"];
exports.modules = {
...
/***/ "(api)/./pages/api/notifications/new.js":
/*!****************************************!*\
  !*** ./pages/api/notifications/new.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _lib_mongodb__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../lib/mongodb */ \"(api)/./lib/mongodb.ts\");\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{\n    try {\n        const mongoClient = await _lib_mongodb__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n        // let databody = {\n        //   userAddress: \"Oxf343r43ff3422dfgt5y5\",\n        //   notification: \"Fourth Notification\",\n        //   clicked: false\n        // };\n        const response = await mongoClient.db(\"MetaLiberation\").collection(\"notifications\").insertOne(req.body);\n        return res.status(200).json(response.insertedId);\n    } catch (err) {\n        console.log(err.message);\n    }\n}); //  .insertOne(databody, (err, data) => {\n //         if (err) return console.log(err);\n //         console.log(\"saved to db: \" + data);\n //       });\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/notifications/new.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/notifications/new.js"));
